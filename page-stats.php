                ...
                <div class="orange-cap-internal"
                    ...
                    <div class="d-flex ">
                        <div class="capplayerimage">
                            <img src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/individualplayer.png" alt="" class="">
                        </div>
                        <div class="cap-details-side">
                            <img src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/orangecap.svg" alt="" class="orangecap">
                            <div class="captitle">
                                ORANGE CAP HOLDER
                            </div>
            ...
            <div class="purple-cap-holder">
                <div class="purple-cap-internal"
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <div class="cap-details-side">
                            <img src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/purplecap.svg" alt="" class="orangecap">
                            <div class="captitle">
                                PURPLE CAP HOLDER
                            </div>
                            <div class="cap-player-name">
