                        ...
                        <ul id="menu-footer-menu" class="menu">
                            ...
                            <li id="menu-item-656"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-656"><a
                                    href="#"> 4S Puneri Bappa</a></li>
                            <li id="menu-item-656"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-656"><a
                                    href="#"> PBG Kolhapur Tuskers</a></li>
                            <li id="menu-item-656"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-656"><a
                                    href="#"> Ratnagiri Jets</a></li>
                            <li id="menu-item-656"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-656"><a
                                    href="#"> Eagle Nashik Titans</a></li>
                            <li id="menu-item-656"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-656"><a
                                    href="#"> Chhatrapti Sambhaji Kings </a></li>
                            <li id="menu-item-656"
                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-656"><a
                                    href="#"> Solapur Royals</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3 ps-5">
                    ...
                    <ul class="social-icons">
                        <li>
                            <a href="https://www.instagram.com/mplt20tournament/?igshid=MzRlODBiNWFlZA=="
                                target="_blank"><img src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/Vector.svg" alt=""></a>
                        </li>
                        <li>
                            <a href="https://twitter.com/mpltournament?s=21&t=2-7IwCyW7Jf5I-D1j1-OFw"
                                target="_blank"><img src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/Vector-1.svg" alt=""></a>
                        </li>
                        <li>
                            <a href="https://www.facebook.com/mplt20tournament?mibextid=LQQJ4d" target="_blank"><img
                                    src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/Vector-2.svg" alt=""></a>
                        </li>
                        <li>
                            <a href="https://www.youtube.com/channel/UCaUZedaymGsM_mJZMAiQzVA" target="_blank"><img
                                    src="<?php echo get_bloginfo('template_directory'); ?>/newassets/images/Vector-3.svg" alt=""></a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 ps-0">
                    <ul class="d-flex px-0 py-3 m-0 justify-content-center justify-content-md-start  w-100">
                        <li><a href="#" class="text-white text-decoration-none">terms & conditions </a>
                        </li>
                        <li><a href="#" class="text-white text-decoration-none mx-3">Privacy policy</a>
                        </li>
